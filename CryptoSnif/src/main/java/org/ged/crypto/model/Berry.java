...
public class Berry {
    ...
    public String toString() {
        ...
        sb.append(Berry.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Berry) == false) {
            return false;
        }
        Berry rhs = ((Berry) other);
