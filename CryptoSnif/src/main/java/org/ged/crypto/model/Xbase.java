...
public class Xbase {
    ...
    public String toString() {
        ...
        sb.append(Xbase.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Xbase) == false) {
            return false;
        }
        Xbase rhs = ((Xbase) other);
