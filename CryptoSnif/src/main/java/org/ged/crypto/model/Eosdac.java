...
public class Eosdac {
    ...
    public String toString() {
        ...
        sb.append(Eosdac.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Eosdac) == false) {
            return false;
        }
        Eosdac rhs = ((Eosdac) other);
