...
public class Horse {
    ...
    public String toString() {
        ...
        sb.append(Horse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Horse) == false) {
            return false;
        }
        Horse rhs = ((Horse) other);
