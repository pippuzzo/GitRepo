...
public class Yoyow {
    ...
    public String toString() {
        ...
        sb.append(Yoyow.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Yoyow) == false) {
            return false;
        }
        Yoyow rhs = ((Yoyow) other);
