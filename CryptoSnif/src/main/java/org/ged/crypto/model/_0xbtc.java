...
public class _0xbtc {
    ...
    public String toString() {
        ...
        sb.append(_0xbtc.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof _0xbtc) == false) {
            return false;
        }
        _0xbtc rhs = ((_0xbtc) other);
