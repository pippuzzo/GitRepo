...
public class Candy {
    ...
    public String toString() {
        ...
        sb.append(Candy.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Candy) == false) {
            return false;
        }
        Candy rhs = ((Candy) other);
