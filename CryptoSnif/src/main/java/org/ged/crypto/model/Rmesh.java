...
public class Rmesh {
    ...
    public String toString() {
        ...
        sb.append(Rmesh.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Rmesh) == false) {
            return false;
        }
        Rmesh rhs = ((Rmesh) other);
