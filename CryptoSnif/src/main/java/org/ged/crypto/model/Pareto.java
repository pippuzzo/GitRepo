...
public class Pareto {
    ...
    public String toString() {
        ...
        sb.append(Pareto.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Pareto) == false) {
            return false;
        }
        Pareto rhs = ((Pareto) other);
