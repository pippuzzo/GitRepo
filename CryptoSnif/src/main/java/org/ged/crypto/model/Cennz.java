...
public class Cennz {
    ...
    public String toString() {
        ...
        sb.append(Cennz.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Cennz) == false) {
            return false;
        }
        Cennz rhs = ((Cennz) other);
