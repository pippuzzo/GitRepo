...
public class Cedex {
    ...
    public String toString() {
        ...
        sb.append(Cedex.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Cedex) == false) {
            return false;
        }
        Cedex rhs = ((Cedex) other);
