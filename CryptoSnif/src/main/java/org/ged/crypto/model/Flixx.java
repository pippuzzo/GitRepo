...
public class Flixx {
    ...
    public String toString() {
        ...
        sb.append(Flixx.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Flixx) == false) {
            return false;
        }
        Flixx rhs = ((Flixx) other);
