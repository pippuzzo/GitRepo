...
public class Srcoin {
    ...
    public String toString() {
        ...
        sb.append(Srcoin.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Srcoin) == false) {
            return false;
        }
        Srcoin rhs = ((Srcoin) other);
