...
public class Ecash {
    ...
    public String toString() {
        ...
        sb.append(Ecash.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Ecash) == false) {
            return false;
        }
        Ecash rhs = ((Ecash) other);
