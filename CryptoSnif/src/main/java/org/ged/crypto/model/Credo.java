...
public class Credo {
    ...
    public String toString() {
        ...
        sb.append(Credo.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Credo) == false) {
            return false;
        }
        Credo rhs = ((Credo) other);
