...
public class Aergo {
    ...
    public String toString() {
        ...
        sb.append(Aergo.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Aergo) == false) {
            return false;
        }
        Aergo rhs = ((Aergo) other);
