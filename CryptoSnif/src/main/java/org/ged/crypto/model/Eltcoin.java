...
public class Eltcoin {
    ...
    public String toString() {
        ...
        sb.append(Eltcoin.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Eltcoin) == false) {
            return false;
        }
        Eltcoin rhs = ((Eltcoin) other);
