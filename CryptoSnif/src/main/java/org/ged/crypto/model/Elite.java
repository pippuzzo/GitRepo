...
public class Elite {
    ...
    public String toString() {
        ...
        sb.append(Elite.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Elite) == false) {
            return false;
        }
        Elite rhs = ((Elite) other);
