...
public class Ncash {
    ...
    public String toString() {
        ...
        sb.append(Ncash.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Ncash) == false) {
            return false;
        }
        Ncash rhs = ((Ncash) other);
