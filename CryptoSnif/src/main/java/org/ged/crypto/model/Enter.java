...
public class Enter {
    ...
    public String toString() {
        ...
        sb.append(Enter.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Enter) == false) {
            return false;
        }
        Enter rhs = ((Enter) other);
