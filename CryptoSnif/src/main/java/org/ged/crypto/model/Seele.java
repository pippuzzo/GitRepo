...
public class Seele {
    ...
    public String toString() {
        ...
        sb.append(Seele.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Seele) == false) {
            return false;
        }
        Seele rhs = ((Seele) other);
