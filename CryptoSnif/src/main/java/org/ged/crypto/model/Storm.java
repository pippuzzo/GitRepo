...
public class Storm {
    ...
    public String toString() {
        ...
        sb.append(Storm.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Storm) == false) {
            return false;
        }
        Storm rhs = ((Storm) other);
