...
public class Stacs {
    ...
    public String toString() {
        ...
        sb.append(Stacs.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Stacs) == false) {
            return false;
        }
        Stacs rhs = ((Stacs) other);
