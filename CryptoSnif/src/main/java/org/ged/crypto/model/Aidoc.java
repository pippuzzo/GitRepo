...
public class Aidoc {
    ...
    public String toString() {
        ...
        sb.append(Aidoc.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Aidoc) == false) {
            return false;
        }
        Aidoc rhs = ((Aidoc) other);
