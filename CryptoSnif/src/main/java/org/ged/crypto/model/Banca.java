...
public class Banca {
    ...
    public String toString() {
        ...
        sb.append(Banca.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Banca) == false) {
            return false;
        }
        Banca rhs = ((Banca) other);
