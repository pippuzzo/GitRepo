...
public class Menlo {
    ...
    public String toString() {
        ...
        sb.append(Menlo.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Menlo) == false) {
            return false;
        }
        Menlo rhs = ((Menlo) other);
