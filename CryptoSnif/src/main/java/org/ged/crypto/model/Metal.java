...
public class Metal {
    ...
    public String toString() {
        ...
        sb.append(Metal.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Metal) == false) {
            return false;
        }
        Metal rhs = ((Metal) other);
