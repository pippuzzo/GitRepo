...
public class Equal {
    ...
    public String toString() {
        ...
        sb.append(Equal.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Equal) == false) {
            return false;
        }
        Equal rhs = ((Equal) other);
