...
public class Joint {
    ...
    public String toString() {
        ...
        sb.append(Joint.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Joint) == false) {
            return false;
        }
        Joint rhs = ((Joint) other);
