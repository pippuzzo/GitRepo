...
public class Hydro {
    ...
    public String toString() {
        ...
        sb.append(Hydro.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Hydro) == false) {
            return false;
        }
        Hydro rhs = ((Hydro) other);
