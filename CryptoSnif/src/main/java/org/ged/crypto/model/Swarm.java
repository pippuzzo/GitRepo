...
public class Swarm {
    ...
    public String toString() {
        ...
        sb.append(Swarm.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Swarm) == false) {
            return false;
        }
        Swarm rhs = ((Swarm) other);
