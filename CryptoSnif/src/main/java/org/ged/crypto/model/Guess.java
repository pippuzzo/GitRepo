...
public class Guess {
    ...
    public String toString() {
        ...
        sb.append(Guess.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Guess) == false) {
            return false;
        }
        Guess rhs = ((Guess) other);
