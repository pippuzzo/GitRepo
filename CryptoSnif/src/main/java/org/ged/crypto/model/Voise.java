...
public class Voise {
    ...
    public String toString() {
        ...
        sb.append(Voise.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Voise) == false) {
            return false;
        }
        Voise rhs = ((Voise) other);
