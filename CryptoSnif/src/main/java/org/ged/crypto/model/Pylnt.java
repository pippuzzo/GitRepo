...
public class Pylnt {
    ...
    public String toString() {
        ...
        sb.append(Pylnt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Pylnt) == false) {
            return false;
        }
        Pylnt rhs = ((Pylnt) other);
