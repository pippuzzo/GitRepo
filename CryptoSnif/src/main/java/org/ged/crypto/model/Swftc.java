...
public class Swftc {
    ...
    public String toString() {
        ...
        sb.append(Swftc.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Swftc) == false) {
            return false;
        }
        Swftc rhs = ((Swftc) other);
