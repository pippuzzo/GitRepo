...
public class Instar {
    ...
    public String toString() {
        ...
        sb.append(Instar.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Instar) == false) {
            return false;
        }
        Instar rhs = ((Instar) other);
