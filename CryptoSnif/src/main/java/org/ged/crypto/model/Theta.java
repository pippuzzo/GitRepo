...
public class Theta {
    ...
    public String toString() {
        ...
        sb.append(Theta.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Theta) == false) {
            return false;
        }
        Theta rhs = ((Theta) other);
