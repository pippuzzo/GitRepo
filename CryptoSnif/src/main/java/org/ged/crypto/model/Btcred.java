...
public class Btcred {
    ...
    public String toString() {
        ...
        sb.append(Btcred.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Btcred) == false) {
            return false;
        }
        Btcred rhs = ((Btcred) other);
