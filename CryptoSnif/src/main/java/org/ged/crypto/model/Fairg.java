...
public class Fairg {
    ...
    public String toString() {
        ...
        sb.append(Fairg.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Fairg) == false) {
            return false;
        }
        Fairg rhs = ((Fairg) other);
