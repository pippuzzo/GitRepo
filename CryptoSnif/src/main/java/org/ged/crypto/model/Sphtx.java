...
public class Sphtx {
    ...
    public String toString() {
        ...
        sb.append(Sphtx.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Sphtx) == false) {
            return false;
        }
        Sphtx rhs = ((Sphtx) other);
