...
public class Sngls {
    ...
    public String toString() {
        ...
        sb.append(Sngls.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Sngls) == false) {
            return false;
        }
        Sngls rhs = ((Sngls) other);
