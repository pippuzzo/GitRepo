...
public class Tgame {
    ...
    public String toString() {
        ...
        sb.append(Tgame.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Tgame) == false) {
            return false;
        }
        Tgame rhs = ((Tgame) other);
