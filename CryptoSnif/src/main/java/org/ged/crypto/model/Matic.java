...
public class Matic {
    ...
    public String toString() {
        ...
        sb.append(Matic.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Matic) == false) {
            return false;
        }
        Matic rhs = ((Matic) other);
