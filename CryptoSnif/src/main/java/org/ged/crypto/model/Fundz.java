...
public class Fundz {
    ...
    public String toString() {
        ...
        sb.append(Fundz.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Fundz) == false) {
            return false;
        }
        Fundz rhs = ((Fundz) other);
