...
public class Robet {
    ...
    public String toString() {
        ...
        sb.append(Robet.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Robet) == false) {
            return false;
        }
        Robet rhs = ((Robet) other);
