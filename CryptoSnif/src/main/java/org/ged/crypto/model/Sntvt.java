...
public class Sntvt {
    ...
    public String toString() {
        ...
        sb.append(Sntvt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Sntvt) == false) {
            return false;
        }
        Sntvt rhs = ((Sntvt) other);
