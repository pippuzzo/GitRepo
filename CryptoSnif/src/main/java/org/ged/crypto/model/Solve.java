...
public class Solve {
    ...
    public String toString() {
        ...
        sb.append(Solve.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Solve) == false) {
            return false;
        }
        Solve rhs = ((Solve) other);
