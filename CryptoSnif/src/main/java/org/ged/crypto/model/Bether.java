...
public class Bether {
    ...
    public String toString() {
        ...
        sb.append(Bether.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Bether) == false) {
            return false;
        }
        Bether rhs = ((Bether) other);
