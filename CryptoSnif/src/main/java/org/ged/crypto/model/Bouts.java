...
public class Bouts {
    ...
    public String toString() {
        ...
        sb.append(Bouts.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Bouts) == false) {
            return false;
        }
        Bouts rhs = ((Bouts) other);
