...
public class Earth {
    ...
    public String toString() {
        ...
        sb.append(Earth.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Earth) == false) {
            return false;
        }
        Earth rhs = ((Earth) other);
