...
public class Erc20 {
    ...
    public String toString() {
        ...
        sb.append(Erc20 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Erc20) == false) {
            return false;
        }
        Erc20 rhs = ((Erc20) other);
