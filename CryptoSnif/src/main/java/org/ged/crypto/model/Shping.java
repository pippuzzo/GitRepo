...
public class Shping {
    ...
    public String toString() {
        ...
        sb.append(Shping.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Shping) == false) {
            return false;
        }
        Shping rhs = ((Shping) other);
