...
public class Wcoin {
    ...
    public String toString() {
        ...
        sb.append(Wcoin.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Wcoin) == false) {
            return false;
        }
        Wcoin rhs = ((Wcoin) other);
