...
public class Kcash {
    ...
    public String toString() {
        ...
        sb.append(Kcash.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Kcash) == false) {
            return false;
        }
        Kcash rhs = ((Kcash) other);
