...
public class Spank {
    ...
    public String toString() {
        ...
        sb.append(Spank.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Spank) == false) {
            return false;
        }
        Spank rhs = ((Spank) other);
