...
public class Boltt {
    ...
    public String toString() {
        ...
        sb.append(Boltt.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Boltt) == false) {
            return false;
        }
        Boltt rhs = ((Boltt) other);
