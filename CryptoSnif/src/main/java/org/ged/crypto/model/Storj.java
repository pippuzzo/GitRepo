...
public class Storj {
    ...
    public String toString() {
        ...
        sb.append(Storj.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Storj) == false) {
            return false;
        }
        Storj rhs = ((Storj) other);
