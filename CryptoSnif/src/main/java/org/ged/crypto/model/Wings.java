...
public class Wings {
    ...
    public String toString() {
        ...
        sb.append(Wings.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Wings) == false) {
            return false;
        }
        Wings rhs = ((Wings) other);
