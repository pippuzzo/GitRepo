...
public class Tfuel {
    ...
    public String toString() {
        ...
        sb.append(Tfuel.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Tfuel) == false) {
            return false;
        }
        Tfuel rhs = ((Tfuel) other);
