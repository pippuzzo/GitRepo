...
public class Carat {
    ...
    public String toString() {
        ...
        sb.append(Carat.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Carat) == false) {
            return false;
        }
        Carat rhs = ((Carat) other);
