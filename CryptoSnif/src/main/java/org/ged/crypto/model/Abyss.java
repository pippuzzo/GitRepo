...
public class Abyss {
    ...
    public String toString() {
        ...
        sb.append(Abyss.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Abyss) == false) {
            return false;
        }
        Abyss rhs = ((Abyss) other);
